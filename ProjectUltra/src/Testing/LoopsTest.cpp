...
void loopsTest()
{
	...
	cout << "\nLoops Test\n\n";
	cout << "This program tests the number of loops, and the length of those loops generated by enciphering the given plain text " + to_string(n) + " times with random settings and then using the \"bombe attack\" loop generator\n";
